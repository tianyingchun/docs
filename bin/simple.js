...
app.use("/", function (req, res) {
  var html = '<!DOCTYPE html>' +
    ...
    '  <link rel="stylesheet" type="text/css" name="common" href="http://localhost:4000/shared/less/public/common.css">' +
    '  <link rel="stylesheet" type="text/css" name="bundle" href="http://localhost:3000/public/docs/react/bundle.css">' +
    '</head>' +
    '  <body>' +
    ...
    '    <script src="http://localhost:3000/public/docs/react/bundle.js"></script>' +
    '  </body>' +
    '</html>';
